...
def worker_thread1(thread_name, run_freq, window):
    ...
    :return:
    """
    print('Starting GetImageThread  - {} that runs every {} ms'.format(thread_name, run_freq))
...
def grabber_main():
    ...
    elements = [
        ...
        [sg.Button('Submit', k='-SUBMIT-', button_color=MOCOLOR), sg.Exit(button_color=MOCOLOR)],
        [sg.Text('_' * 80)],
    ]
